    ...
    import search_engine.parser.SiteCrawler;
    import search_engine.settings.Site;
    import search_engine.settings.SearchSettings;
    import search_engine.dto.response.ErrorResponse;
    import search_engine.dto.response.OkResponse;
    import search_engine.model.*;
    ...
    public class IndexServiceImpl implements IndexService {
        ...
        public ResponseEntity startIndexing() {
            ...
            for (Site site : sites.getSites()) {
                new Thread(() -> {
                    ...
                    new ForkJoinPool().invoke(new SiteCrawler(pageDataList.get(0), pageDataList, this));
        ...
        public ResponseEntity indexPage(String url) {
            ...
            try {
                ...
                log.debug(new ErrorResponse("Страница не доступна"));
        ...
        public void insertAllData(List<PageData> pageDataList, SiteData siteData) {
            ...
            for (PageData pageData : pageDataList) {
                ...
                HashMap<String, Integer> lemmasMap = LemmaFind.getLemmaMap(pageData.getContent());
        ...
        public Document getDocument(String url) throws IOException {
            ...
            return Jsoup.connect(url)
                    .userAgent(searchSettings.getUserAgent())
